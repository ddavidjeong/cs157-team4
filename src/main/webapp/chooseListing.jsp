...
<body>
	...
	<form method="post" action="modifyListing.jsp">
		...
		<br> Max Number of People: <input type="text" name="num" required><br>
		...
		<table border="1">
			...
			try {
				...
				while (rs.next()) {
					...
					out.println("<tr>" + "<td>" + optionNum + "</td>" + "<td>" + rs.getString("start_date") + "</td>"
							+ "<td>" + rs.getString("end_date") + "</td>" + "<td>" + rs.getInt("max_headcount") + "</td>"
							+ "<td>" + rs.getInt("bd_count") + "</td>" + "<td>" + rs.getInt("br_count") + "</td>" + "<td>"
							+ rs.getString("type") + "</td>" + "<td>" + rs.getDouble("price") + "</td>" + "<td>"
							+ rs.getString("street") + "</td>" + "<td>" + rs.getString("city") + "</td>" + "<td>"
							+ rs.getString("state") + "</td>" + "<td>" + rs.getInt("zip_code") + "</td>" + "</tr>");
