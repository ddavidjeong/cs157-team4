...
<body>
	...
	<form method="post"
		...
		<label for="userid">userid:</label> <input type="number" id="userid"
	...
	<br>
	<br> Forgot user ID or email address?
		<a href="identify.jsp" target="_blank"><button type="button">next</button></a>
	</div>
</body>
</html>
