...
<body>
	<h2>Modify/Update property</h2>
		...
		<form method="post" action="modifyProperty.jsp">
			Number of Bedroom: <input type="number" name="numBedRoom" required><br>
			<br> Number of Bathroom: <input type="number" name="numBath"
				required><br> <br> Type: <input type="text"
				name="type" required><br> <br> Price per night: <input
				type="number" name="price" requred><br> <br>
